...
$sql = "select DISTINCT * from (select * from Recommendation where userId = $postUser) as recommend left join posts on recommend.postId = posts.postId order by recommend.votes desc";
